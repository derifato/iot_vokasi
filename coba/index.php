...
?>
    ...
    <div class="col">
      ...
      <a href="proses_update2.php?status2=on"><button type="button" class="btn btn-success">Nyalakan lampu</button></a>
	 <br><br>
	 <a href="proses_update2.php?status2=off"><button type="button" class="btn btn-danger">Matikan lampu</button></a>
	 <br>
